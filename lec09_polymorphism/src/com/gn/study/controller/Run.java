...
public class Run {
	public static void main(String[] args) {
		...
		int i_num = 3;
		double d_num = i_num;
		System.out.println(d_num ); // 업캐스팅
		System.out.println("==========================");
		Beverage b1 = new Coffee(); // 업캐스팅
		Beverage b2 = new OrangeJuice();
		
		b1.drink(); // Coffee의 메소드
//		b1.ice(); 부모는 자식의 메소드를 사용할수없음
		...
		// 5. 동적 바인딩 ->오버라이딩. 다형성과 직접적으로 연관되어있음.
		Planet p1 = new Earth();
		Planet p2 = new Mars();
	...
	System.out.println("============================");
		// 6. 추상 메소드
//		Animal a= new Animal(); -> 추상클래스는 인스턴스화X(구현체X)
	
		Animal dog = new Dog(); // 반드시 상속하여 객체 생성.
		dog.sound();
		Animal cat = new Cat();
		cat.sound();
	System.out.println("===========================");
