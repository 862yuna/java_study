...
public class CompareOperator {
	public static void main(String[] args) {
		...
		System.out.println(andBool); //둘 중 하나라도 false 이면 false
		
		// (2) OR : 6은 5보다 크고, 또는 6은 7보다 큰가요?
		boolean orBool = a>5 || a>c;
		System.out.println(orBool); // 둘 중 하나라도 true 일 때는 true 반환
		
		// 8. 논리 부정 연산자
		boolean isTrue = true;
		boolean isFalse = !isTrue;
		System.out.println(isFalse); //false 반환 !붙이면 반대가됨.
		
		// 논리 연산자(&&, ||) 와 함께 사용
		boolean test1 = 3 < 5; // true
		boolean test2 = 6 < 5; // false
		
		// true && false -> false -> true ( !로 부정했기에 true 반환)
